    ...
    public partial class Main : Form
    {
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            _toggleActors[CounterType.Cpu] = Program.ChartActors.ActorOf(
                Props.Create(() => new ButtonToggleActor(
                        _coordinatorActor, 
                        btnCpu,
                        CounterType.Cpu, 
                        false))
                    .WithDispatcher("akka.actor.synchronized-dispatcher")); // HOCON in App.config can override this
            ...
            _toggleActors[CounterType.Disk] = Program.ChartActors.ActorOf(
                Props.Create(() => new ButtonToggleActor(
                        ...
                        CounterType.Disk,
                        false))
                    .WithDispatcher("akka.actor.synchronized-dispatcher")); // HOCON in App.configcan override this
